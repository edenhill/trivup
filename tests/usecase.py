...
if __name__ == '__main__':
    ...
    # One ZK
    zk1 = ZookeeperApp(cluster, bin_path='/home/maglun/src/kafka/bin/zookeeper-server-start.sh')  # noqa: E501
    ...
    if not cluster.wait_operational(30):
        print('# Cluster did not go operational: letting you troubleshoot ' +
              'in shell')
    print('# Connect to cluster with bootstrap.servers %s' % bootstrap_servers)

    print('\033[32mCluster started.. Executing interactive shell, exit ' +
          'to stop cluster\033[0m')
